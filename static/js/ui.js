    ...
    renderNavbar(user) {
        return `
            <div class="header-content" style="display:flex; justify-content:space-between; align-items:center; padding: 0.5rem 0;">
                <div class="logo" onclick="window.router.navigate('/')" style="cursor: pointer; display: flex; align-items: center; gap: 20px;">
                    <!-- كبرت الارتفاع إلى 120px -->
                    <img src="/static/5213008082009529582_121.jpg" alt="3Minds" style="height: 120px; object-fit: contain;">
                    <span style="font-weight: 800; font-size: 2.2rem; color: #4f46e5; letter-spacing: -0.5px;">3Minds</span>
                </div>
