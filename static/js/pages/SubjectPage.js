            ...
            <div class="glass-panel" style="padding: 2rem; border-right: 6px solid ${subject.color || '#4f46e5'}; background: white; border-radius: 12px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">
                ...
                ${isAdmin && errorDetails ? 
                    `<div style="margin-top: 20px; padding: 10px; background: #fff5f5; border: 1px dashed red;">
                        ...
                        <button onclick="window.router.navigate('/admin')" class="btn btn-primary" style="margin-top:10px;">الذهاب للوحة التحكم</button>
                     </div>` 
                : ''}
            </div>
        </div>
                        ...
                        <div class="card" style="padding: 1.5rem; display: flex; flex-direction: column; gap: 1rem;">
                            ...
                            <div style="display: flex; gap: 0.75rem;">
                                <a href="${item.url || '#'}" target="_blank" class="btn btn-primary" style="flex: 1; text-align: center;">
                                    <i class="ph ph-eye" style="margin-left: 5px;"></i> عرض
                                </a>
                                <a href="${getDownloadLink(item.url)}" target="_blank" class="btn" style="flex: 1; text-align: center; background: #10b981; color: white; text-decoration: none;">
                                    <i class="ph ph-download-simple" style="margin-left: 5px;"></i> تحميل
                                </a>
                            </div>
                        </div>
                    `).join('')}
